...
export function ConfigPanel({ config, onConfigUpdate }: ConfigPanelProps) {
  ...
  return (
    <div className="h-full space-y-8 relative">
        ...
        <div className="flex items-center justify-between h-full">
          <div className="flex items-center space-x-6">
            ...
            <div>
              ...
              <p className="modern-font text-base" style={{ color: '#8e8e93' }}>Configure thermal thresholds, cooling parameters, and email settings</p>
            </div>
          </div>
          
          <div className="flex items-center space-x-6">
            {hasChanges && (
              <div className="flex items-center space-x-3 px-4 py-3 modern-display"
                   style={{ 
            ...
            <div className="modern-display px-6 py-3 modern-font text-base font-semibold"
                 style={{ 
                   backgroundColor: hasChanges ? 'rgba(255, 149, 0, 0.1)' : 'rgba(52, 199, 89, 0.1)',
                   borderColor: hasChanges ? 'rgba(255, 149, 0, 0.3)' : 'rgba(52, 199, 89, 0.3)',
                   color: hasChanges ? '#ff9500' : '#34c759',
                 }}>
      ...
      <div className="relative flex h-[calc(100%-280px)]">
        {/* Left Side - 40% - Temperature & Cooling */}
        <div className="w-[40%] pr-4 space-y-6">
          {/* Temperature Control */}
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="modern-input w-full px-3 py-3 modern-font text-sm"
                  style={{ 
                    background: 'rgba(255, 255, 255, 0.05)',
                    borderColor: 'rgba(255, 255, 255, 0.1)',
                    color: '#ffffff',
        ...
        <div className="w-[40%] pl-4 space-y-6">
          {/* System Parameters */}
