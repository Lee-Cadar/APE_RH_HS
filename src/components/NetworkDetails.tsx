          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="modern-display p-4 text-center">
                <div className="text-sm font-bold modern-font" style={{ color: '#007aff' }}>Max Down</div>
                <div className="text-xs modern-font" style={{ color: '#8e8e93' }}>10 MB/s</div>
              </div>
              <div className="modern-display p-4 text-center">
                <div className="text-sm font-bold modern-font" style={{ color: '#ff9500' }}>Max Up</div>
                <div className="text-xs modern-font" style={{ color: '#8e8e93' }}>5 MB/s</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="modern-panel p-8 shadow-lg">
          ...
          <div className="space-y-8">
            ...
            <div className="modern-display p-6">
              <h4 className="text-lg font-bold modern-font mb-6" style={{ color: '#ffffff' }}>Connection</h4>
